...
#' @name Student
#' @export Student BadStudent Teacher

# ^^^^^^^^^^^^^^^^ Export the 'Student' C++ class by explicitly requesting
# Student be exported via roxygen2's export tag.  Also, provide a name for the Rd
# file.
