...
int main(int argc, char** argv) {
    ...
    A << 0.165300 << 0.454037 << 0.995795 << 0.124098 << 0.047084 << endr << 0.688782 << 0.036549 << 0.552848
      << 0.937664 << 0.866401 << endr << 0.348740 << 0.479388 << 0.506228 << 0.145673 << 0.491547 << endr << 0.148678
      << 0.682258 << 0.571154 << 0.874724 << 0.444632 << endr << 0.245726 << 0.595218 << 0.409327 << 0.367827
      << 0.385736 << endr;
    ...
    A.save("/tmp/A.txt", raw_ascii);

    // load from file
    mat B;
    B.load("/tmp/A.txt");

    // sub matrices 左上和右下截出来的子矩阵
